...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
		...
		// 	'Textbox', null, null, 'text textbox textarea'),
 		...
 		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 120, 80, '', 'Node', null, null, 'oval ellipse state'),
		...
		this.createEdgeTemplateEntry('curved=1;edgeStyle=orthogonalEdgeStyle;endArrow=classic;html=1;', 40, 80, '', 'Arc Line'),
		...
		// }))
		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;container=1;w=110;h=70;strokeWidth=1;fillColor=#f5f5f5;strokeColor=#666666;fontColor=#333333;', 240, 160, '', 'Container', null, null, 'circle'),
	];
